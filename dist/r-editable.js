	...
	var REditable = function (_React$Component) {
	  ...
	  _createClass(REditable, [{
	    ...
	    value: function createDropdown() {
	      return _react2.default.createElement(
	        'select',
	        { className: 'r-editable', value: this.state.value, onChange: this._onChange, onBlur: this._onBlur },
	    ...
	    value: function createInput() {
	      return _react2.default.createElement('input', { autoFocus: true, className: 'r-editable', type: 'text', onBlur: this._onBlur, onChange: this._onChange, value: this.state.value, onKeyPress: this._onKeyInput });
	    }
	  }]);
