...
/***/ function(module, exports, __webpack_require__) {
	...
	var REditable = function (_React$Component) {
	  ...
	  function REditable(props) {
	    ...
	    Array('_onClick', '_onChange').forEach(function (f) {
	  ...
	  _createClass(REditable, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.isEditing) {
	        ...
	        return _react2.default.createElement(
	          'span',
	          { className: 'inner-content', onClick: this._onClick },
	          this.state.value
	        );
	      }
	    }
	    ...
	    value: function createInput() {
	      return _react2.default.createElement('input', { type: 'text', onChange: this._onChange, value: this.state.value });
	    }
	  }]);
