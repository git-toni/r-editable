...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var REditable = function (_React$Component) {
					_inherits(REditable, _React$Component);
	
					function REditable(props) {
						_classCallCheck(this, REditable);
	
						var _this = _possibleConstructorReturn(this, (REditable.__proto__ || Object.getPrototypeOf(REditable)).call(this, props));
						...
						Array('_onClick', '_onChange', '_onBlur', '_onKeyInput').forEach(function (f) {
							return _this[f] = _this[f].bind(_this);
						});
						return _this;
					}
	
					_createClass(REditable, [{
						key: 'render',
						value: function render() {
							if (this.state.isEditing) {
								return this.renderEditable();
							} else {
								return _react2.default.createElement('span', { className: 'r-editable', onClick: this._onClick }, this.renderValue());
							}
						}
					}, {
						key: '_onChange',
								...
								case 'dropdown':
									if (this.state.value) {
										return this.props.options.filter(function (e) {
											return e.value === _this2.state.value;
										})[0].name;
									} else {
										return _react2.default.createElement('span', { className: 'empty-placeholder' }, 'Empty');
									}
								default:
						...
						value: function renderEditable() {
							switch (this.state.type) {
								case 'dropdown':
									return this.createDropdown.call(this);
								case 'input':
						...
						value: function createDropdown() {
							var actualProps = (0, _omit2.default)(this.props, ['onChange', 'value', 'onBlur', 'onKeyInput', 'options']);
							return _react2.default.createElement('select', _extends({}, actualProps, { className: 'r-editable', value: this.state.value, onChange: this._onChange, onBlur: this._onBlur }), this.props.options.map(function (el) {
								return _react2.default.createElement('option', { key: el.value, value: el.value }, el.name);
							}));
						}
					}, {
						key: '_onKeyInput',
						value: function _onKeyInput(e) {
							if (e.key === 'Enter') {
								this.setState({ isEditing: false });
							}
						}
						...
						value: function createInput() {
							var actualProps = (0, _omit2.default)(this.props, ['onChange', 'value', 'onBlur', 'onKeyInput']);
							return _react2.default.createElement('input', _extends({ autoFocus: true }, actualProps, { className: 'r-editable', type: 'text', onBlur: this._onBlur, onChange: this._onChange, value: this.state.value, onKeyPress: this._onKeyInput }));
						}
					}, {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var arrayMap = __webpack_require__(4),
				    ...
				    flatRest = __webpack_require__(59),
	    ...
	    */
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var flatten = __webpack_require__(60),
	...
	;
	//# sourceMappingURL=r-editable.js.map
